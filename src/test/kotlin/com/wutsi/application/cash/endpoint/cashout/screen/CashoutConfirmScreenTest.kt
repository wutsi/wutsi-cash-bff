...
internal class CashoutConfirmScreenTest : AbstractEndpointTest() {
    ...
    fun confirmWithFeesToSender() {
        ...
        assertEndpointEquals("/screens/cashout/confirm-fees-to-sender.json", url)
    }
    ...
    fun confirmWithFeesToRecipient() {
        ...
        assertEndpointEquals("/screens/cashout/confirm-fees-to-recipient.json", url)
    }
    ...
    fun confirmWithNoFees() {
        ...
        assertEndpointEquals("/screens/cashout/confirm-no-fees.json", url)
    }
}
